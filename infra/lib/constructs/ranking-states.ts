...
export class RankingStates extends Construct {
    ...
    const datasetGroupFunction = new lambda.Function(
      ...
      'DatasetGroupFunction',
      {
        ...
        code: lambda.Code.fromAsset(
          path.resolve(__dirname, '..', '..', 'functions', 'sfn', 'ranking')
        ),
  ...
  private createStateMachine(
    ...
    retryCheckReadyTask
      ...
      .otherwise(
        new sfn.Wait(this, 'WaitForRankingTask', {
    ...
    return new sfn.StateMachine(this, 'RankingStateMachine', {
