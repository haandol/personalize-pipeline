...
import { UsecaseStates } from '../constructs/usecase-states';
import {
  StatesRequestModels,
  RequestValidators,
...
export class UsecaseStack extends Sfn.BaseStack {
  public readonly stateMachine: sfn.IStateMachine;

  constructor(scope: Construct, id: string, props: Props) {
    super(scope, id, props);

    const states = new UsecaseStates(this, 'UsecaseStates', props);
    ...
    this.registerSfnIntegration({
      resource: api.root.addResource('usecase'),
      methodOptions: {
        ...this.methodOptions,
        requestModels: {
          'application/json': props.requestModels.UsecaseModel,
        },
